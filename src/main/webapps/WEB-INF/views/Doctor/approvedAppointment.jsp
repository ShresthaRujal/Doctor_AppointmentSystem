...
<button name="search" class="btn btn-flat" id="search-btn" type="submit"><i class="fa fa-search"></i>
            ...
            <ul class="sidebar-menu">
                <li><a href="/doctors/${doctor.did}"><i class="fa fa-link"></i> <span>My Profile</span></a></li><li class="treeview">
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Approved Appointment Request.</h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${appointments}" var="appointment">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/doctorAppointments/${id}/doctorAppointmentsApproval/${appointment.id}?value=0" style="text-decoration: none;" class="btn btn-warning">${appointment.status}</a>
                                            </td>
